...
if(x=="2"){xxx="how-to-learn-blogging-software.html"}
if(x=="3"){xxx="1affiliate-marketing-and-blogging.htm"}
if(x=="4"){xxx="learning-how-to-make-money-blogging.html"}
a_to_ve[i].href="https://lewatin-duluya.blogspot.com/2020/08/"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
